...
class TweetBuzz {
  ...
  factory TweetBuzz.fromMap(Map<String, dynamic> map, String docId) {
    return TweetBuzz(
      id: map['id'] as String,
      docId: docId,
  ...
  factory TweetBuzz.fromJson(String source) =>
      TweetBuzz.fromMap(json.decode(source) as Map<String, dynamic>, '');

  factory TweetBuzz.fromDocument(DocumentSnapshot source) =>
      TweetBuzz.fromMap(source.data() as Map<String, dynamic>, source.id);
  ...
  factory TweetBuzz.fromDocumen(Map<String, dynamic> data, String docId) {
    return TweetBuzz(
      id: data['id'],
      docId: docId,
      ...
      views: data['views'] != null
          ? List<CampusBuzzUser>.from(
              data['views'].map((view) => CampusBuzzUser.fromDocument(view)))
          : null,
      ...
      likes: data['likes'] != null
          ? List<CampusBuzzUser>.from(
              data['likes'].map((like) => CampusBuzzUser.fromDocument(like)))
          : null,
  ...
  factory TweetBuzz.fromSnaption(DocumentSnapshot snapshot) =>
      TweetBuzz.fromDocumen(
